...
X_signal = np.vstack((massK0S_sig_np, tImpParBach_sig_np, tImpParV0_sig_np, CtK0S_sig_np, cosPAK0S_sig_np, nSigmapr_sig_np, dcaV0_sig_np)).T
X_background = np.vstack((massK0S_bkg_np, tImpParBach_bkg_np, tImpParV0_bkg_np, CtK0S_bkg_np, cosPAK0S_bkg_np, nSigmapr_bkg_np, dcaV0_bkg_np)).T
...
variable_names = ['massK0S', 'tImpParBach', 'tImpParV0', 'CtK0S', 'cosPAK0S', 'nSigmapr', 'dcaV0']
...
plt.xticks(ticks=np.arange(len(variable_names)), labels=variable_names, rotation=90)
