...
\begin{comment}
    \begin{table}[h]
        ...
        \begin{tabular}{c | c | c}
            ...
            \midrule
            massK0S                   & massa invariante della particella $V^{0}$ , ottenuta a partire dalle tracce ricostruite delle figlie & \qty{497}{\mega \eV \per \clight} \\
            tlmpParBach               &  \\
            tlmpParV0                 &   \\
            ctK0S                     &   \\
            cosPAK0S                  &   \\
...
\section{Introduzione alla classificazione e applicazione delle reti neurali}
    ...
    \begin{figure}[h]
        ...
        \caption{Classificazione del DL nelle AI come spiegato nella lezione del MIT~\cite{MIT_2023}.}
...
% CODICE PYTHON MODELO RETE NEURALE
...
\begin{comment}
        Sai quanto vale l'integrale della curva di ROC? Lo si potrebbe utilizzare come indicatore della bontà del training. Dicendo 

No, purtoppo in realtà il programma non lo restituisce
\end{comment}
...
% E poi mettendo il nostro valore possiamo dare una conclusione qualitativa sulla bontà del training.
